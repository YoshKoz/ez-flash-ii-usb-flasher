...
ops_list = [
    ...
    (0x30,'JNB d,r',3),(0x32,'RETI',1),(0x33,'RLC A',1),
    (0x34,'ADDC A,#i',2),(0x38,'ADDC A,R0',1),(0x39,'ADDC A,R1',1),(0x3A,'ADDC A,R2',1),
    (0x3B,'ADDC A,R3',1),(0x3C,'ADDC A,R4',1),(0x3D,'ADDC A,R5',1),(0x3E,'ADDC A,R6',1),
    (0x3F,'ADDC A,R7',1),
    ...
    for _ in range(n):
        ...
        if size == 2 and pc+1 < len(data):
            ...
            if mnem.startswith(('SJMP','JZ','JNZ','JC','JNC')):
                ...
                extra = f' 0x{imm:02X}'
            elif 'MOV' in mnem and 'DPTR' not in mnem and mnem != 'MOVC':
                extra = f' 0x{imm:02X}'
...
print('=== cmd 0x02 handler at 0x07B7 ===')
lines = disasm(patched, 0x07B7, 90)
for l in lines:
    print(l)

print()
print('=== cmd 0x01 handler at 0x075E (ROM read, for comparison) ===')
lines = disasm(patched, 0x075E, 90)
for l in lines:
    print(l)

print()
print('=== EEPROM handler 0x0806-0x08A0 ===')
lines = disasm(patched, 0x0806, 0xA0)
for l in lines:
    print(l)

print()
print('=== cmd 0x14 handler at 0x0AE1 ===')
lines = disasm(patched, 0x0AE1, 40)
for l in lines:
    print(l)

print()
print('=== 0x0A00 (common LJMP target for save handler completion) ===')
lines = disasm(patched, 0x0A00, 30)
for l in lines:
    print(l)

print()
print('=== LCALL 0x114A (FLASH/SRAM handler) ===')
lines = disasm(patched, 0x114A, 30)
for l in lines:
    print(l)

print()
print('=== LCALL 0x145F (other handler) ===')
lines = disasm(patched, 0x145F, 30)
for l in lines:
    print(l)
