...
ops_list = [
    ...
    (0x30,'JNB d,r',3),(0x32,'RETI',1),(0x33,'RLC A',1),(0x34,'ADDC A,#i',2),
...
print('=== LCALL 0x133C (read EEPROM data) ===')
lines = disasm(patched, 0x133C, 60)
for l in lines:
    print(l)

print()
print('=== 0x0A00 completion path (data copy loop) ===')
lines = disasm(patched, 0x0A00, 90)
for l in lines:
    print(l)

print()
print('=== 0x172D (from cmd 0x01 ROM read - cart wait) ===')
lines = disasm(patched, 0x172D, 20)
for l in lines:
    print(l)
